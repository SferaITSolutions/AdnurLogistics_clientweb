  ...
  const items = [
    {
      ...
      children: (
        <div className="flex flex-col gap-3 pt-2 px-1">
          <InfoRow label={t('productName')} value={productData?.productName || '-'} />
          <InfoRow label={t('description')} value={productData?.productDescription || '-'} />
          <InfoRow label={t('quantity')} value={productData?.productCount || '-'} />
          <InfoRow label={t('priceSum')} value={productData?.productRate || '-'} />
          <InfoRow
            label={t('totalAmount')}
      ...
      className: '!rounded-lg !border-none !p-0 !m-0',
    },
  ];
