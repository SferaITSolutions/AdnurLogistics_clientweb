...
export default function FormRequest() {
  ...
  const { values, setValue, resetForm } = useFormRequestStore();
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: "Ism va familiyangizni kiriting" },
                {
                  min: 2,
                  message:
                    "Ism va familiya kamida 2 ta belgidan iborat bo‘lishi kerak",
                },
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                { required: true, message: "Unique number kiriting" },
                {
                  min: 4,
                  message:
                    "Unique number kamida 4 ta belgidan iborat bo‘lishi kerak",
                },
              ]}
            >
